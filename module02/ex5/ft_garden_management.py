        ...
        try:
            for plant in self.plants:
                ...
                if water > 10:
                    ...
                    raise PlantError(f"Sunlight hours {hour} is too low (min 2)")
                elif hour > 12:
                    raise PlantError(f"Sunlight hours {hour} is too high (max 12)")
                else:
                    print(f"{plant['name_plant']}: healthy (water: {water}, sun: {hour})")
